...
?>										
										...
										<tr>
										<th>Order Token</th>
											<td><?php echo htmlentities($row['otk']);?></td>
												<th>Payment Screenshot</th>
											<td><a href="../payment_ss/<?php echo htmlentities($row['uid'].$row['username']."/".$row['ops']); ?>" target="_blank">
        <img src="../payment_ss/<?php echo htmlentities($row['uid'].$row['username']."/".$row['ops']); ?>" width="100">
    </a></td>
										</tr>
										<tr>
